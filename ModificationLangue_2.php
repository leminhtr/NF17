     ...
     <a href="page1_projet.php"> Retourner ¨¤ l'acceuil ! </a>  <br>
        ...
        <?php  
             ...
             include "connect_projet.php";
              ...
              if(!empty($niveau)){
		      			 $query_str = "update Individus,Candidats,Parler_Langue set niveau_langue='{$niveau}' where mail='{$email}' and Candidats.id_candidat=Individus.id_individu and Parler_Langue.id_candidat=Candidats.id_candidat";   
