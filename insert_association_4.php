...
<?php
	...
	$vSQL = "SELECT * FROM Postes_Associations_Traduits WHERE id_asso = '$vId_asso' AND type = '$vtype1' AND langue = '$vlangue1';";
	$vQuery = pg_query($vCon,$vSQL);
	if(pg_fetch_array($vQuery, NULL, PGSQL_ASSOC) == NULL){
	...
	$vSQL = "SELECT * FROM Postes_Associations_Traduits WHERE id_asso = '$vId_asso' AND type = '$vtype2' AND langue = '$vlangue2';";
	$vQuery = pg_query($vCon,$vSQL);
	if(pg_fetch_array($vQuery, NULL, PGSQL_ASSOC) == NULL){
