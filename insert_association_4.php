...
<?php
	...
	$vSQL = "SELECT * FROM Postes_Associations_traduite WHERE id_asso = '$vId_asso' AND type = '$vtype2' AND langue = '$vlangue2';";
	$vQuery = pg_query($vCon,$vSQL);
	if(pg_fetch_array($vQuery, NULL, PGSQL_ASSOC) == NULL){
		$vSQL2 = "INSERT INTO Formation_traduite(description,langue,id_asso) VALUES ('$vDesc2','$vlangue2','$vId_asso');";
		pg_query($vCon,$vSQL2);
	}
