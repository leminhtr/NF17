...
<?php
	...
	$vSQL = "SELECT * FROM Postes_Associations_Traduits WHERE id_asso = '$vid_asso' AND description = '$vDesc1' AND langue = 'FR';";
	$vQuery = pg_query($vCon,$vSQL);

	//On regarde si le tuple (id_asso, description, 'FR') existe
	...
	$vDesc2 = $_POST['description2'];
	$vSQL = "SELECT * FROM Postes_Associations_Traduits WHERE id_asso = '$vid_asso' AND description = '$vDesc2' AND langue = 'EN';";
	$vQuery = pg_query($vCon,$vSQL);

	//On regarde si le tuple (id_asso, description, 'EN') existe
